package chav1961.bt.mediaplayer.filters.http;
...
import chav1961.bt.mediaplayer.filters.MediaInfo.VideoInfo;
...
public class HttpMedia {
    ...
    public HttpMedia(URL url, File cacheWhere) throws IOException {
        ...
        String data = requestInfo(url, HttpUtils.getHttpClient(url.toExternalForm()));
    ...
    private String requestInfo(URL url, HttpClient client) throws IOException {
        ...
        HttpResponse response = HttpUtils.privilegedExecute(client, get);
