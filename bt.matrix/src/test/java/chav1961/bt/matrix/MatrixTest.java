...
public class MatrixTest {
	...
	public void basicTest() {
		try(final MatrixLib	lib =  MatrixLib.getInstance()) {
			...
			Assert.assertArrayEquals(new float[] {0f,0f,0f,0f,0f,0f,0f,0f,0f}, matrix.extract(),  0.0001f);
			
			matrix.assign(new float[] {1f,2f,3f,4f,5f,6f,7f,8f,9f});
			
			Assert.assertArrayEquals(new float[] {1f,2f,3f,4f,5f,6f,7f,8f,9f}, matrix.extract(),  0.0001f);
	...
	public void simpleArithmeticTest() {
		try(final MatrixLib	lib =  MatrixLib.getInstance()) {
			...
			Assert.assertArrayEquals(new float[] {2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f, 10f}, matrix1.add(1).extract(), 0.0001f);
			Assert.assertArrayEquals(new float[] {2f, 4f, 6f, 8f, 10f, 12f, 14f, 16f, 18f}, matrix1.add(matrix2).extract(), 0.0001f);
			Assert.assertArrayEquals(new float[] {0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f}, matrix1.sub(matrix2).extract(), 0.0001f);
			Assert.assertArrayEquals(new float[] {2f, 4f, 6f, 8f, 10f, 12f, 14f, 16f, 18f}, matrix1.mul(2).extract(), 0.0001f);
			Assert.assertArrayEquals(new float[] {1f, 4f, 9f, 16f, 25f, 36f, 49f, 64f, 81f}, matrix1.mulH(matrix2).extract(), 0.0001f);
			Assert.assertArrayEquals(new float[] {1f, 4f, 7f, 2f, 5f, 8f, 3f, 6f, 9f}, matrix1.trans().extract(), 0.0001f);
		}
	}
	...
	public void specialArithmeticTest() {
		try(final MatrixLib	lib =  MatrixLib.getInstance()) {
			...
			Assert.assertArrayEquals(new float[] {30, 36, 42, 66, 81, 96, 102, 126, 150}, matrix1.mul(matrix2).extract(), 0.0001f);
			...
			Assert.assertArrayEquals(new float[] {0f, 5f, 0f, 10f, 6f, 7f, 12f, 14f, 0f, 15f, 0f, 20f, 18f, 21f, 24f, 28f}, matrix4.mulK(matrix5).extract(), 0.0001f);

			final Matrix	matrix6 = lib.getZeroMatrix(3, 3);
			
			matrix6.assign(new float[] {1f, 2f, 3f, 4f, 1f, 2f, 3f, 4f, 1f});

			Assert.assertArrayEquals(new float[] {-7f/36f, 5f/18f, 1f/36f, 1f/18f, -2f/9f, 5f/18f, 13f/36f, 1f/18f, -7f/36f}, matrix6.inv().extract(), 0.0001f);
		}
	}
}
