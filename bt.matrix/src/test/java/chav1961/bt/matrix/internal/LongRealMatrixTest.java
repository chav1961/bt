...
public class LongRealMatrixTest {

	@Test
	public void basicTest() {
		try(final LongRealMatrix	m = new LongRealMatrix(2, 3)) {
			...
			final LongRealMatrix	m2 = new LongRealMatrix(2, 3);
			final LongRealMatrix	m3 = new LongRealMatrix(3, 2);
			...
			final LongRealMatrix	m4 = new LongRealMatrix(2, 1);
	...
	@Test
	public void addTest() {
		try(final LongRealMatrix	m1 = new LongRealMatrix(2, 3);
			final LongRealMatrix	m2 = new LongRealMatrix(2, 3)) {
	...
	public void ordinalMulTest() {
		try(final LongRealMatrix	m1 = new LongRealMatrix(2, 3);
			final LongRealMatrix	m2 = new LongRealMatrix(3, 2);
			final LongRealMatrix	mX = new LongRealMatrix(4, 4);) {
			Matrix	m3;
	...
	public void tensorMulTest() {
		try(final LongRealMatrix	m1 = new LongRealMatrix(3, 3);
			final LongRealMatrix	m2 = new LongRealMatrix(2, 2)) {
			Matrix	m3;
	...
	public void unaryTest() {
		try(final LongRealMatrix	m = new LongRealMatrix(3, 3)) {
