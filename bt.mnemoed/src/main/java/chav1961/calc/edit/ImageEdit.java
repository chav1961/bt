...
//    int  rezhim=0;
	...
	private void chooseColor() {
        final JColorChooser	chooser = new  JColorChooser(maincolor);
        final Color[]		temp = new Color[] {maincolor}; 
	...
	private void setColor(final Color color) {
		japan.setBorder(new LineBorder(maincolor = color, 3));
	}
