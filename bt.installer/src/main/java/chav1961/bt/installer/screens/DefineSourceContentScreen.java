...
public class DefineSourceContentScreen extends AbstractWizardStep {
	private final WizardStepOption[]	options;
	
	public DefineSourceContentScreen(final String stepId, final String caption, final String description, final String helpId, final WizardStepOption... options) {
	...
	public ScreenType getScreenType() {
		return ScreenType.DEFINE_SOURCE_CONTENT;
	}
