...
public class DefineDatabaseConnectionScreen extends AbstractWizardStep {
	private final WizardStepOption[]	options;

	public DefineDatabaseConnectionScreen(final String stepId, final String caption, final String description, final String helpId, final WizardStepOption... options) {
	...
	public ScreenType getScreenType() {
		return ScreenType.DEFINE_DATABASE_CONNECTION;
	}
