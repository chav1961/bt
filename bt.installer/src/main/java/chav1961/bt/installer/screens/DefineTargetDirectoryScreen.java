...
public class DefineTargetDirectoryScreen extends AbstractWizardStep {
	...
	public DefineTargetDirectoryScreen(final String stepId, final String caption, final String description, final String helpId, final WizardStepOption... options) {
